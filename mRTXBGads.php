...
?>
            <div class="col-md-8 mx-auto">
                <center>
		        <h1 class="colorboard"></i>Novo Anúncio</h1>
	            </center>
				<div class="card bg-primary text-white">
					<div class="card-header">
						<center>
							<h2><i class="fa fa-eye"></i> Adicionar anúncio</h2>
						</center>
					</div>
					<div class="card-body">
        				<form method="post">
...
?>
            <div class="col-md-8 mx-auto">
                <center>
		        <h1 class="colorboard"></i>Editar Anúncio</h1>
	            </center>
				<div class="card bg-primary text-white">
					<div class="card-header">
						<center>
							<h2><i class="fa fa-file-image-o"></i> Editar Anúncio</h2>
						</center>
					</div>
					<div class="card-body">
                            <form method="post">
...
//main table/form
	...
	<center>
		...
		<a id="button" href="./<?php echo $base_file ?>?create" class="btn btn-primary"> ADD NOVO</a>
	</center>
	<br>
