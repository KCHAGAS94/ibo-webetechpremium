    ...
    <div class="card border-left-primary shadow h-100 card shadow mb-4">
        ...
        <div class="card-body">
           <?php
						...
						echo '<h3>Método:</h3>';
						echo '<input type="radio" name="upload-type" id="upload-radio" checked> Selecionar logo a partir do arquivo &nbsp&nbsp';
                        echo '<input type="radio" name="upload-type" id="url-radio"> Selecionar logo a partir da URL';
                        echo '<br>';
                        ...
                        <form method="post" enctype="multipart/form-data" id="upload-form">
                            ...
                            <button class="custom-button btn btn-success btn-icon-split" type="submit" name="upload">Enviar Arquivo</button>
                        </form>
