...
?>
            <div class="col-md-8 mx-auto">
                <center>
		        <h2 class="colorboard"></i>Novo Banner</h2>
	            </center>
				<div class="card bg-primary text-white">
					<div class="card-header">
						<center>
							<h2><i class="fa fa-eye"></i> Adicionar novo Banner</h2>
						</center>
					</div>
					<div class="card-body">
        				<form method="post">
...
?>
            <div class="col-md-8 mx-auto">
                <center>
		        <h1 class="colorboard"></i>Editar Banner</h1>
	            </center>
				<div class="card bg-primary text-white">
					<div class="card-header">
						<center>
	...
	<center>
		...
		<br>
            <form action=rename.php method=get >
                <input type=submit class="horizontal-space btn btn-success btn-icon-split" value='  MUDAR PARA AUTOMÁTICO  ' />
            </form>
        <br>
			...
			<tbody>
				<tr>
					...
					<td>
						...
						&nbsp;&nbsp;&nbsp;
						<a class="btn btn-danger btn-ok" href="#" data-href="<?php echo $base_file ?>?delete=<?=$row['id'] ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash "></i></a>
					</td>
				</tr>
			</tbody>
			<?php }?>
