...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-1 text-gray-800"> Plano de Fundo do Aplicativo</h1>
    <!-- Custom codes -->
    <div class="card border-left-primary shadow h-100 card shadow mb-4">
        ...
        <div class="card-body">
           <?php
						...
						echo '<h3>Método:</h3>';
						echo '<input type="radio" name="upload-type" id="upload-radio" checked> Eviar Arquivo &nbsp&nbsp';
                        echo '<input type="radio" name="upload-type" id="url-radio"> Usar URL';
                        echo '<br>';
                        ...
                        <!--<form method="post" enctype="multipart/form-data">
                            <label for="image">Selecione imagem para enviar:</label>
                        ...
                        <form method="post" enctype="multipart/form-data" id="upload-form">
                            ...
                            <input class="custom-button" type="file" name="image" id="image" accept="image/jpeg, image/png, image/gif">
                            <button class="custom-button btn btn-success btn-icon-split" type="submit" name="upload"><span</button>Enviar Arquivo</button>
                        </form>
                        
                        <form method="post" id="url-form">
                            <label for="image-url">Insira o link da imagem:</label>
                            <input class="custom-button" type="text" name="image-url" id="image-url" placeholder="https://example.com/image.jpg">
